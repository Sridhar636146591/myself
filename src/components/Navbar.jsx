    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <button
            onClick={() => setIsDark(!isDark)}
            className="w-9 h-9 rounded-full flex items-center justify-center bg-slate-100/80 dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 text-slate-700 dark:text-yellow-400 active:scale-95 transition-all duration-300 shadow-sm cursor-pointer"
            title={isDark ? "Switch to Light Mode" : "Switch to Dark Mode"}
          >
            {isDark ? (
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
