...
const AllCertificationsPage = () => {
  const certifications = [
    ...
    {
      title: "FusionX Hackathon 2026",
      issuer: "FusionX",
      date: "2026",
      credentialUrl: "/certificates/fusion x .PDF",
      icon: (
        <svg className="w-10 h-10 text-[#06b6d4] dark:text-[#ff2a2a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Web Sprint (Innovatex 4.0)",
      issuer: "Innovatex 4.0",
      date: "2026",
      credentialUrl: "/certificates/web.pdf",
      icon: (
        <svg className="w-10 h-10 text-[#06b6d4] dark:text-[#ff2a2a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
        </svg>
  ...
  return (
    <div className="bg-slate-50 dark:bg-black min-h-screen pt-32 pb-28 px-6 md:px-12 w-full text-slate-800 dark:text-white relative overflow-hidden font-sans transition-colors duration-300">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#38bdf8]/10 dark:bg-[#ff2a2a]/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#06b6d4]/5 dark:bg-[#ff2a2a]/5 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certifications.map((cert, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#38bdf8]/5 to-transparent dark:from-[#ff2a2a]/5 dark:to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-[2rem] pointer-events-none" />
