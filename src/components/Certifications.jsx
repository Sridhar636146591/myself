...
const Certifications = () => {
  const certifications = [
    {
      ...
      icon: (
        <svg className="w-10 h-10 text-[#06b6d4] dark:text-[#ff2a2a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      date: "Recent",
      credentialUrl: "/certificates/inAF.pdf",
      icon: (
        <svg className="w-10 h-10 text-[#06b6d4] dark:text-[#ff2a2a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
        </svg>
    ...
    {
      title: "Internship Certificate Xylofy AI",
      issuer: "Xylofy AI",
      date: "2026",
      credentialUrl: "/certificates/intenship XYlofy AI Certificate.pdf",
      icon: (
        <svg className="w-10 h-10 text-[#06b6d4] dark:text-[#ff2a2a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
        </svg>
  ...
  return (
    <section id="certifications" className="bg-white dark:bg-neutral-950 py-28 px-6 md:px-12 w-full relative overflow-hidden font-sans text-slate-800 dark:text-white transition-colors duration-300">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certifications.map((cert, idx) => (
            <div 
              ...
              className="group relative bg-white rounded-[2rem] p-8 border border-[#38bdf8]/20 shadow-[0_0_20px_rgba(6,182,212,0.12)] dark:bg-neutral-900/50 dark:border-[#ff2a2a]/20 dark:shadow-[0_0_20px_rgba(255,42,42,0.12)] hover:border-[#38bdf8]/50 dark:hover:border-[#ff2a2a]/60 hover:shadow-[0_0_32px_rgba(6,182,212,0.25)] dark:hover:shadow-[0_0_32px_rgba(255,42,42,0.28)] transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between"
            >
              {/* Background accent on hover */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#38bdf8]/5 to-transparent dark:from-[#ff2a2a]/5 dark:to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-[2rem] pointer-events-none"></div>

              <div className="relative z-10">
                <div className="mb-6 p-4 bg-slate-50 dark:bg-black/40 rounded-2xl inline-block group-hover:scale-110 transition-transform duration-500 border border-slate-100 dark:border-neutral-800">
                  {cert.icon}
                </div>
                
                <h3 className="text-xl font-bold text-[#0f172a] dark:text-white mb-2 group-hover:text-[#06b6d4] dark:group-hover:text-[#ff2a2a] transition-colors duration-300">
                  {cert.title}
                </h3>
                
                <p className="text-slate-500 dark:text-white/50 font-medium mb-1">
                  {cert.issuer}
                </p>
              </div>

              <div className="relative z-10 mt-8 pt-6 border-t border-slate-100 dark:border-neutral-800 flex justify-between items-center">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 text-slate-800 dark:text-white font-bold text-sm group-hover:text-[#06b6d4] dark:group-hover:text-[#ff2a2a] transition-colors"
                >
                  View Credential
        ...
        <div className="mt-20 flex justify-end">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-[#38bdf8] to-[#06b6d4] dark:from-[#ff2a2a] dark:to-red-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0" />
            <span className="relative z-10 group-hover:text-white">View All Certifications</span>
